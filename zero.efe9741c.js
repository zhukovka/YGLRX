...
},{"rxjs":81,"rxjs/operators":83,"./piano":79}],30:[function(require,module,exports) {
"use strict";
...
var slides = codeContainer.querySelectorAll('pre');
...
document.addEventListener("keydown", function (e) {
    ...
    if (e.code === "Space") {
        ...
        setTimeout(function () {
            return audioPlayer.play('D_3');
        }, 1142);
        setTimeout(function () {
            return audioPlayer.play('G3');
        }, 542);
        setTimeout(function () {
            return audioPlayer.play('A_3');
        }, 442);
        setTimeout(function () {
            return audioPlayer.play('G3');
        }, 342);
...
},{"../audioPlayer":58}]},{},[30], null)
//# sourceMappingURL=/zero.37d75b20.map